 ...
 *      -Pósiciones de memoria de los periféricos disponibles en el micro descrito en
 *      la tabla 1 (Memory Map)
 *      -Incluye los demás registros de los perigéricos
...
/*
 * Base addresess of Flash and SRAM memories
 * Datasheet, Memory Map, Figure 14
 * (Remember, 1HByte = 1024 bytes
 */

#define FLAS_BASE_ADDR 			0x08000000U    //Esta es la memoria del programa, 512KB
#define SRAM_BASE_ADDR			0x20000000U    // Esta es la memoria RAM, 128 KB.

/* NOTA: Observar que existen unos registros específicos del Cortex M4 en la region 0xE000000U
 * Los controladores de las interrupciones se encuentran allí, por ejemplo.
 * Esto se vera a su debido tiempo.
 */

/* NOTA:
 * Ahora agregamos la direcci´pon de memoria base para cada uno de los periféricos que posee el micro
 * En el "datasheet" del micro, Figura 14 (Memory map) encontramos el mapa de los buses:
 * -APB1 (AdvancPeripheral Bus)
 * -APB2
 * -AHB1 ( Advance Hig-Performance Bus)
 * -AHB2
 */

/**
 * AHBx and APBx Bus Peripheral base addreses
 */
 ...
 * NOTA: NO los necesitamos para este ejercicio , NO copiar
 ...
 * #define SPIO_BASE_ADDR		(APB2_BASE_ADDR + 0x2C00U)
 ...
 * NOTA: NO los necesitamos en el ejercicio, NO copiar
...
/* Definicion de la estructura de datos que representa a cada uno de los regustros que componen el
 * periferico RCC.
 *
...
typedef struct
{
	volatile uint32_t CR;			//Clock Control Registrer 					ADDR_OFFSET:	0x00
	volatile uint32_t PLLCFGR;		//PLL Configuration Registrer				ADDR_OFFSET: 	0x04
 ...
 * que el nuevo elemenro "RCC" queda disponible para cada clase .c (archivo .c) que incluya este archivo
 * */
...
/* Definicion de la estructura de datos que representa a cada uno de los registrops que componen el
 * periferico GPIO.
