 ...
 *Repito el ciclo con el numero dividido entre 2 hasta que ya no se pueda dividir */
   ...
   a[i]=n%2;
   n=n/2;
   /*Imprimo cada elemento de la matriz concatenado empezando desde el final hasta el principio*/
   }
   for(i=i-1;i>=0;i--)
   {
   printf("%d",a[i]);
   ...
   b[i]=h%2;
   h=h/2;
   /*Imprimo cada elemento de la matriz b[] desde el ultimo elemento hasta el primero*/
   }
   for(i=i-1;i>=0;i--)
   {
   printf("%d",b[i]);
   ...
   c[i]=k%16;
   k=k/16;
   /*Imprimo cada elemento de la matriz c[] desde el ultimo elemento hasta el primero*/
   }
   for(i=i-1;i>=0;i--)
   {
   printf("%d",c[i]);
